...
namespace example_simple_report_subscriber
{
    ...
    private:
        ...
        rclcpp::Subscription<simple_report_node::msg::Status>::SharedPtr subscription_;
    ...
    void SimpleSubscriber::initialize(){
        ...
        auto topic_callback =
            [this](simple_report_node::msg::Status::UniquePtr msg) -> void {
                RCLCPP_INFO(this->get_logger(), msg->node_status == 1 ? "Received: SUCCESS" : "Received: FAILURE");
            };
        subscription_ =
            this->create_subscription<simple_report_node::msg::Status>("bt_status", 10, topic_callback);
...
RCLCPP_COMPONENTS_REGISTER_NODE(example_simple_report_subscriber::SimpleSubscriber);